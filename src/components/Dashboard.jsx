...
const stats = [
  { label: "New", value: "111K" },
  { label: "Contacted", value: "722K" },
  { label: "Qualified", value: "96k" },
  { label: "Working", value: "155K" },
  { label: "Proposal Sent", value: "168K" },
  { label: "Customer", value: "1.9K", color: "green" },
  { label: "Lost Leads", value: "7.9K", color: "red" },
];
      ...
      <div className="topbar">
        ...
        <div className="profile-section">
          <div className="profile" onClick={toggleProfileMenu}>
            <img src="https://i.pravatar.cc/36?img=11" alt="User" />
            <div>
              <strong>Sonu</strong>
              <p>sonu@sonu.com</p>
            </div>
